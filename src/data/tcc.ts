...
export const FEUILLES: Feuille[] = [
  {
    ...
    champs: [
      ...
      { type: 'zone', id: 'argument_pour', label: '5. Argument(s) pour cette pensée', aide: 'Quels faits, vraiment factuels, vont dans le sens de cette pensée ? (Pas des impressions — des preuves concrètes.)', placeholder: 'Ex. : elle a déjà toussé la semaine dernière...' },
      { type: 'zone', id: 'argument_contre', label: '6. Argument(s) contre cette pensée', aide: 'Quels faits vont à l\'encontre de cette pensée ? Qu\'est-ce qu\'un observateur neutre remarquerait ?', placeholder: 'Ex. : elle joue et mange normalement, pas de fièvre...' },
      { type: 'distorsions', id: 'distorsions', label: '7. Les pièges de pensée que je repère', aide: 'Coche les distorsions présentes dans ta pensée automatique. Les reconnaître, c\'est déjà les désamorcer.' },
      { type: 'zone', id: 'pensee_alternative', label: '8. Ma pensée alternative et équilibrée', aide: 'En t\'appuyant sur tes deux colonnes d\'arguments : quelle est la pensée la plus juste et la plus complète ? Que dirais-tu à ton meilleur ami ?', placeholder: 'Ex. : une toux chez un enfant est banale ; je surveille, et je consulte si ça persiste...' },
      { type: 'curseur', id: 'intensite_apres', label: '9. Nouvelle intensité de ma croyance / émotion (0-100)', aide: 'Réévalue ton émotion maintenant. Même une baisse de 10 points est une victoire.' },
    ],
  },
  {
    slug: 'actionnable',
