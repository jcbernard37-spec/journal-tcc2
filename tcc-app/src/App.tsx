    ...
    <nav className="nav no-print">
      ...
      {menuOuvert && (
        <div className="nav-mobile-menu">
          ...
          <NavLink to="/outils-therapeutiques" className={({ isActive }) => 'nav-lien-mobile' + (isActive ? ' actif' : '')} onClick={() => setMenuOuvert(false)}>🧠 Outils</NavLink>
